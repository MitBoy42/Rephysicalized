...
namespace Rephysicalized
{
    ...
    bool isAlgaeStego = prefabTag == TagManager.Create("AlgaeStego") || prefabTag == TagManager.Create("AlgaeStegoBaby");
            ...
            monitor.possibleEatPositionOffsets = [Vector3.zero];
        ...
        private static FueledDiet BuildStegoFueledDietPeat()
        {
            ...
            var mainFoodOverrides = new Dictionary<Tag, float>
            {
                ...
                { TagManager.Create(PrickleFruitConfig.ID), 246f / Rephysicalized.FoodDensityRebalance.IngredientMultiplier[PrickleFruitConfig.ID.ToTag()] },
