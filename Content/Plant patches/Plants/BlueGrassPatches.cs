...
namespace Rephysicalized
{
    ...
    public static class Bluegrass_AddToDescription
    {
        public static void Postfix()
        {
            const string key = "STRINGS.CREATURES.SPECIES.BLUEGRASS.DESC";
            Strings.Add(key, Strings.Get(key) + "\n\n <b>REPHYSICALIZED: Massively increases CO2 consumption and Oxygen production under light. At 100 000 Lux or higher, it will consume 100g/s of CO2 and convert 75% of it into Oxylite.</b>");
        }
    }
